...
$lang['required'] 			= "'%s'는(은) 필수항목입니다.";
$lang['isset']				= "'%s' 필드는 반드시 필요한 값입니다.";
$lang['valid_email']		= "'%s' 올바른 이메일 주소가 아닙니다.";
...
$lang['exact_length']		= "'%s'는(은) '%s' 글자입니다.";
...
$lang['less_than']				= "'%s' 필드는 '%s'보다 작아야 합니다.";
$lang['less_than_equal_to']		= "'%s' 필드는 '%s'보다 작거나 같아야 합니다.";
$lang['greater_than']			= "'%s' 필드는 '%s'보다 커야 합니다.";
$lang['greater_than_equal_to']	= "'%s' 필드는 '%s'보다 크거나 같아야 합니다..";

$lang['is_update_unique'] 				= "이미 사용중인 '%s' 입니다.";
$lang['valid_bizno'] 				= "올바른 사업자등록번호가 아닙니다.";
$lang['required_hidden'] 	= "'%s'이 선택되지 않았습니다.";
$lang['numeric_dash'] 	= "'%s'는(은) 숫자와 하이픈(-) 만 가능합니다.";
