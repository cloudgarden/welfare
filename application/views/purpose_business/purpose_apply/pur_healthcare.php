			...
			<table class="table">
				<tbody>
					...
					<tr>
						<th>진료일자</th>
						<td>
						<input type="text" name='occur_date' id='occur_date' style="width:90px">
						</td>

						<th>입원기간</th>
						<td>
						<input type="text" name='hospitalization_start' id='hospitalization_start' style="width:90px">
						-
						<input type="text" name='hospitalization_end' id='hospitalization_end' style="width:90px">
						</td>
					</tr>
					<tr>
						<th>신청금액</th>
