			...
			<table class="table">
				<tbody>
					<tr>
						...
						<th>유형</th>
						<td>
							<select name='long_term_kind' style="width:150px">
								<?php foreach ($all_list['long_term_kind'] as $long_term_kind) { ?>
									<option value='<?php echo $long_term_kind; ?>'><?php echo $long_term_kind; ?></option>
								<?php } ?>
							</select>
						</td>
					</tr>
